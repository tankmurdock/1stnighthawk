    ...
    <footer className="bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              >
                ...
                <div className="absolute -right-8 top-2 w-8 h-8 opacity-20">
                  <img
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">1stnighthawkllc@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-4 h-4 text-primary-400" />
                <span className="text-gray-300">+1 (904) 338-3032</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-4 h-4 text-primary-400" />
                <span className="text-gray-300">Jacksonville, Florida</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li>
                <span className="text-gray-300">Animation & Interactions</span>
              </li>
              <li>
                <span className="text-gray-300">Component Libraries</span>
              </li>
              <li>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center relative"
        >
